        ...
        <div style={{ 
          ...
          <div className="visual-sector">
            ...
            <div style={{ display: 'flex', gap: '15px', marginTop: '20px', overflowX: 'auto', padding: '10px' }}>
              ...
              {product.gallery && typeof product.gallery === 'string' && product.gallery.split(',').map((imgUrl: string, index: number) => {
                ...
                return (
                  <img 
                    ...
                    style={{ 
                      width: '80px', height: '80px', objectFit: 'cover', cursor: 'pointer',
                      border: currentImg === fullUrl ? '3px solid #FFCC80' : '2px solid transparent',
                      borderRadius: '10px',
                      backgroundColor: '#FFF8E1'
                    }}
